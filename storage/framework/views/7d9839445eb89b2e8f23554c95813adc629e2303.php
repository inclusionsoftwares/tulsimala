                ...
                <?php if( isset($advertisementThree[0])): ?>
                    <a <?php if(isset($one)): ?> href="<?php echo e($one); ?>" <?php endif; ?> class="col-lg-6 col-md-12 no-padding">
                        <img
                            ...
                            <?php if(! $isLazyLoad): ?> src="<?php echo e(asset('/storage/' . $advertisementThree[0])); ?>" <?php endif; ?>
                            data-src="<?php echo e(asset('/storage/' . $advertisementThree[0])); ?>" alt="" />
                    </a>
                <?php endif; ?>
                ...
                <div class="col-lg-6 col-md-12 second-panel">
                    <?php if( isset($advertisementThree[1])): ?>
                        <a <?php if(isset($two)): ?> href="<?php echo e($two); ?>" <?php endif; ?> class="row top-container">
                            <img
                                ...
                                <?php if(! $isLazyLoad): ?> src="<?php echo e(asset('/storage/' . $advertisementThree[1])); ?>" <?php endif; ?>
                                data-src="<?php echo e(asset('/storage/' . $advertisementThree[1])); ?>" alt="" />
                        </a>
                    <?php endif; ?>
                    <?php if( isset($advertisementThree[2])): ?>
                        <a <?php if(isset($three)): ?> href="<?php echo e($three); ?>" <?php endif; ?> class="row bottom-container">
                            <img
                                class="col-12 pr0 <?php echo e($isLazyLoad ? 'lazyload' : ''); ?>"
                                <?php if(! $isLazyLoad): ?> src="<?php echo e(asset('/storage/' . $advertisementThree[2])); ?>" <?php endif; ?>
                                data-src="<?php echo e(asset('/storage/' . $advertisementThree[2])); ?>" alt="" />
                        </a>
                    <?php endif; ?>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH C:\wamp64\www\bagisto/resources/themes/velocity/views/home/advertisements/advertisement-three.blade.php ENDPATH**/ ?>