            ...
            <tr>
                ...
                <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($isClosure): ?>
                        ...
                        <?php if(isset($column['wrapper']) && gettype($column['wrapper']) === 'object' && $column['wrapper'] instanceof \Closure): ?>
                            ...
                            <?php endif; ?>
                        <?php elseif(isset($column['closure']) && gettype($column['closure']) === 'object' && $column['closure'] instanceof \Closure): ?>
...
<?php /**PATH C:\wamp64\www\bagisto\packages\Webkul\Ui\src/resources/views/datagrid/body.blade.php ENDPATH**/ ?>