...
<?php $__env->startPush('css'); ?>
    <?php if(! empty($sliderData)): ?>
        <link rel="preload" as="image" href="<?php echo e(asset('/storage/' . $sliderData[0]['path'])); ?>">
    <?php else: ?>
...
<?php echo $__env->make('shop::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bagisto/resources/themes/velocity/views/home/index.blade.php ENDPATH**/ ?>