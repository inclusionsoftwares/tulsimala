...
<mobile-header
    ...
    :all-locales="<?php echo e(json_encode(core()->getCurrentChannel()->locales)); ?>"
...
>
    ...
    <div class="row">
        ...
        <div class="right-vc-header col-6">
            <a href="<?php echo e(auth()->guard('customer')->check() ? route('velocity.customer.product.compare') : route('velocity.product.compare')); ?>" class="compare-btn unset">
                <i class="material-icons">compare_arrows</i>
            </a>
            <a href="<?php echo e(route('customer.wishlist.index')); ?>" class="wishlist-btn unset">
    ...
    <template v-slot:top-header>
        <?php echo $__env->make('velocity::shop.layouts.particals.compare', ['isText' => false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <?php echo $__env->make('velocity::shop.layouts.particals.wishlist', ['isText' => false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </template>
...
</mobile-header><?php /**PATH C:\wamp64\www\bagisto\packages\Webkul\Velocity\src/resources/views/shop/layouts/header/mobile.blade.php ENDPATH**/ ?>