            ...
            <div class="row">
                <?php if( isset($advertisementTwo[0])): ?>
                    <a class="col-lg-9 col-md-12 no-padding">
                        <img
                            ...
                            <?php if(! $isLazyLoad): ?> src="<?php echo e(asset('/storage/' . $advertisementTwo[0])); ?>" <?php endif; ?>
                            data-src="<?php echo e(asset('/storage/' . $advertisementTwo[0])); ?>" alt="" />
                    </a>
                <?php endif; ?>
                ...
                <?php if( isset($advertisementTwo[1])): ?>
                    <a class="col-lg-3 col-md-12 pr0">
                        <img
                            class="<?php echo e($isLazyLoad ? 'lazyload' : ''); ?>"
                            <?php if(! $isLazyLoad): ?> src="<?php echo e(asset('/storage/' . $advertisementTwo[1])); ?>" <?php endif; ?>
                            data-src="<?php echo e(asset('/storage/' . $advertisementTwo[1])); ?>" alt="" />
                    </a>
                <?php endif; ?>
            </div>
        </div>
...
<?php endif; ?><?php /**PATH C:\wamp64\www\bagisto/resources/themes/velocity/views/home/advertisements/advertisement-two.blade.php ENDPATH**/ ?>