            ...
            Vue.component('datagrid-filters', {
                ...
                methods: {
                    ...
                    searchCollection: function (searchValue) {
                        this.formURL("search", 'all', searchValue, '<?php echo e(__('ui::app.datagrid.search-title')); ?>');
                    },
                    ...
                    arrayFromUrl: function () {
                        ...
                        for (let i = 0; i < moreSplitted.length; i++) {
                            ...
                            switch (obj.column) {
                                case "search":
                                    obj.label = "<?php echo e(__('ui::app.datagrid.search-title')); ?>";
                                    break;
                                case "channel":
                                    obj.label = "<?php echo e(__('ui::app.datagrid.channel')); ?>";
                                    ...
                                    break;
                                case "locale":
                                    obj.label = "<?php echo e(__('ui::app.datagrid.locale')); ?>";
                                    ...
                                    break;
                                case "customer_group":
                                    obj.label = "<?php echo e(__('ui::app.datagrid.customer-group')); ?>";
...
<?php /**PATH C:\wamp64\www\bagisto\packages\Webkul\Ui\src/resources/views/datagrid/table.blade.php ENDPATH**/ ?>