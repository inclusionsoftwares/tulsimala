    ...
    <div class="d-inline-block">
        <div class="dropdown">
            <div class="locale-icon">
                <?php if($currentLocaleImageSource = app(\Webkul\Velocity\Helpers\Helper::class)->getCurrentLocaleImageSource()): ?>
                    <img src="<?php echo e($currentLocaleImageSource); ?>" alt="" width="20" height="20" />
                <?php endif; ?>
            </div>
...
<?php /**PATH C:\wamp64\www\bagisto/resources/themes/velocity/views/layouts/top-nav/locale-currency.blade.php ENDPATH**/ ?>