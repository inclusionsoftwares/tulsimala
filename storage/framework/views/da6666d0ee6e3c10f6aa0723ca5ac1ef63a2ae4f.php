                    ...
                    <div class="main-content-wrapper col-12 no-padding">
                        ...
                        <header class="row velocity-divide-page vc-header header-shadow active">
                            ...
                            <div class="vc-small-screen container">
                                <?php echo $__env->make('velocity::shop.layouts.header.mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>

                            
                            <?php echo $__env->make('velocity::shop.layouts.header.desktop', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\wamp64\www\bagisto/resources/themes/velocity/views/layouts/master.blade.php ENDPATH**/ ?>