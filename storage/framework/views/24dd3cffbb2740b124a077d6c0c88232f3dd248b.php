                    ...
                    <?php if(isset($advertisementFour[0])): ?>
                        <a <?php if(isset($one)): ?> href="<?php echo e($one); ?>" <?php endif; ?> aria-label="Advertisement">
                            <img
                                ...
                                <?php if(! $isLazyLoad): ?> src="<?php echo e(asset('/storage/' . $advertisementFour[0])); ?>" <?php endif; ?>
                                data-src="<?php echo e(asset('/storage/' . $advertisementFour[0])); ?>" alt="" />
                        </a>
                    <?php endif; ?>
                </div>
                    ...
                    <?php if(isset($advertisementFour[1])): ?>
                        <a <?php if(isset($two)): ?> href="<?php echo e($two); ?>" <?php endif; ?> class="row col-12 remove-padding-margin" aria-label="Advertisement">
                            <img
                                ...
                                <?php if(! $isLazyLoad): ?> src="<?php echo e(asset('/storage/' . $advertisementFour[1])); ?>" <?php endif; ?>
                                data-src="<?php echo e(asset('/storage/' . $advertisementFour[1])); ?>" alt="" />
                        </a>
                    <?php endif; ?>
                    ...
                    <?php if(isset($advertisementFour[2])): ?>
                        <a <?php if(isset($three)): ?> href="<?php echo e($three); ?>" <?php endif; ?> class="row col-12 remove-padding-margin" aria-label="Advertisement">
                            <img
                                ...
                                <?php if(! $isLazyLoad): ?> src="<?php echo e(asset('/storage/' . $advertisementFour[2])); ?>" <?php endif; ?>
                                data-src="<?php echo e(asset('/storage/' . $advertisementFour[2])); ?>" alt="" />
                        </a>
                    <?php endif; ?>
                </div>
                ...
                <div class="col-lg-4 col-12 advertisement-container-block no-padding">
                    <?php if(isset($advertisementFour[3])): ?>
                        <a <?php if(isset($four)): ?> href="<?php echo e($four); ?>" <?php endif; ?> aria-label="Advertisement">
                            <img
                                class="<?php echo e($isLazyLoad ? 'lazyload' : ''); ?>"
                                <?php if(! $isLazyLoad): ?> src="<?php echo e(asset('/storage/' . $advertisementFour[3])); ?>" <?php endif; ?>
                                data-src="<?php echo e(asset('/storage/' . $advertisementFour[3])); ?>" alt="" />
                        </a>
                    <?php endif; ?>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH C:\wamp64\www\bagisto/resources/themes/velocity/views/home/advertisements/advertisement-four.blade.php ENDPATH**/ ?>